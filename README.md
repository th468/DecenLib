...
*   **課題 :**
    - 多数のフロアや棚に分散した蔵書を活用したいが、専用のスペースや人員を用意する余裕がない。

*   **解決策 :** 
    1. ウェブアプリケーション上で書籍の表示、検索機能を実装することで、物理的には分散させたまま、必要な書籍へのアクセスを可能にする。  
    2. また、アプリケーション内で貸出、返却33機能を実装することで、利用者の端末のみで貸し借りのサイクルを完結させ、司書の常駐を不要とした。

<br/>

## アプリケーションの機能

本アプリケーションは、図書館アプリとしての基本的な検索機能の他、貸出、返却をユーザー自身で実行できる機能を実装しています。
